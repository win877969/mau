...
<div class="tablinks" onclick="openCity(event, 'v2rayaktif')" id="defaultOpen">
  ...
  <thead>
    ...
    <script src="https://bmkg.xyz/http://bmkg.xyz/lib/chart/chart.min.js"></script>
    <script src="https://bmkg.xyz/lib/easing/easing.min.js"></script>
    <script src="https://bmkg.xyz/lib/waypoints/waypoints.min.js"></script>
    <script src="https://bmkg.xyz/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="https://bmkg.xyz/lib/tempusdominus/js/moment.min.js"></script>
    <script src="https://bmkg.xyz/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="https://bmkg.xyz/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>


    <!-- Template Javascript -->
    <script src="https://bmkg.xyz/js/main.js"></script>
<!-- Table Javascript -->
